...
dot_img_file = r'../models/images/multi_input_model.png'
...
log_folder = "../logs/MultiInput/" + datetime.now().strftime("%Y%m%d-%H%M%S")
...
model.save("../resources/saved_multi_input_model.h5")
