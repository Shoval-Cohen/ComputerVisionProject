...
from models.defs import transfer_learning
...
# conv_results = data_augmentation(image_input)
# conv_results = kaggle_model.getModel()(conv_results)
...
log_folder = "logs/Basic/transfer_learning/ResNet50/" + datetime.now().strftime("%Y%m%d-%H%M%S")
